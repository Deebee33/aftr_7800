...
bluepts
```
notice that the aethetic `blue` is within geom_point which opperates on the entire scatterplot. this is diffrent from within aes where it is specifically confined to a specific variable/class
