...
setwd("C:/Users/Administrator/Dropbox/Documents/Work and School/Teaching/CPLN 671 - Statistics and Data Mining/Data/Lecture 16 - R")
...
#(with the lrm command below) gives R-squared as part of the output
